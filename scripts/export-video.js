...
app.whenReady().then(async () => {
  console.log('🚀 Launching 4K Video Renderer Engine (3840x2160 @ 60 FPS - 33s Fast Timeline)...');
  ...
  const FPS = 60;
  const TOTAL_SECONDS = 33;
  const TOTAL_FRAMES = TOTAL_SECONDS * FPS;
  let frameCount = 0;

  console.log(`🎥 Capturing ${TOTAL_FRAMES} frames (33.0s @ 60 FPS)...`);
